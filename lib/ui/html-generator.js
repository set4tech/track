      ...
      <div class="header">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
          <div style="display: flex; align-items: center; gap: 4px;">
            <a href="#" onclick="clearAllFilters(); return false;" style="display: flex; align-items: center; cursor: pointer;" title="Reset all filters">
              <img src="/set4-logo.svg" alt="Set4" style="height: 40px; width: auto;">
            </a>
            <span style="font-size: 20px; color: #888; font-weight: 400; margin-left: -2px;">track</span>
          </div>
