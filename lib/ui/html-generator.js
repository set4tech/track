      ...
      <div class="header">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
          ...
          <div style="display: flex; align-items: center; gap: 12px;">
            <a href="/api/slack-install-page" class="slack-button" title="Add to Slack">
              <svg style="width: 18px; height: 18px;" viewBox="0 0 122.8 122.8" fill="currentColor">
        ...
        <div class="search-container">
          <div class="search-input-wrapper">
            <input 
              type="text" 
              id="searchInput" 
              placeholder="Search decisions, emails, and content..." 
              class="search-input"
              autocomplete="off"
            />
