...
const SAMPLE_DECISIONS = [
  ...
  },
  {
    ...
    raw_thread: "Following our React 18 migration success, I've decided to upgrade our Next.js stack to v14. The App Router will significantly improve our marketing site performance."
  },
  {
    ...
    raw_thread: "With our team growing to 12 developers, I've decided to implement micro-frontends. This will allow each team to work independently while maintaining consistency."
  },
  {
    ...
    raw_thread: "After Q1's digital ad success, I'm approving $30k for content marketing in Q2. We need to build our organic presence to reduce paid ad dependency."
  },
  {
    ...
    raw_thread: "With our aggressive hiring goals, I've decided to launch an employee referral program. Our employees know great talent and this will speed up our recruitment."
  },
  {
    ...
    raw_thread: "Following our 4-day work week pilot success, I've decided to implement flexible PTO. This will further improve work-life balance and help with recruitment."
  },
  {
    ...
    raw_thread: "With 80% of our team working remotely, I've decided to provide monthly stipends for home office expenses. This investment will pay off in productivity and retention."
  },
  // More Frontend Architecture decisions to create a proper timeline
  {
    ...
    raw_thread: "After several production bugs due to prop type mismatches, I've decided we need to adopt TypeScript across all our React components. This will catch errors before they reach production."
  },
  {
    ...
    raw_thread: "To improve our component styling consistency and maintainability, I've decided to implement styled-components. This will give us better component isolation and dynamic styling capabilities."
  },
  {
    ...
    raw_thread: "Our current testing setup is slowing down development. I've decided to upgrade to React Testing Library and Vitest for better testing practices and faster execution."
  },
  // More Marketing Budget decisions for timeline
  {
    ...
    raw_thread: "Based on Q2 content marketing success, I'm increasing our social media ad spend for Q3. We need to capitalize on the momentum and brand awareness we've built."
  },
  {
    ...
    raw_thread: "To establish our company as a thought leader, I'm approving $25k for conference sponsorships and speaking opportunities. This will position us as industry experts."
  },
  // More HR Policy decisions for timeline
  {
    ...
    raw_thread: "To improve team cohesion, especially with our remote workforce, I've decided to implement a monthly team building budget. Teams can use this for activities that bring them together."
  },
  {
    ...
    raw_thread: "To retain talent and keep our skills current, I'm launching a professional development fund. Each employee gets $2,000 annually for learning and growth opportunities."
  },
  {
    ...
    raw_thread: "Our current annual review process isn't providing enough feedback. I've decided to implement quarterly check-ins with annual formal reviews for better performance management."
  }
];
...
async function seedDatabase() {
  ...
  try {
    ...
    console.log('   • Frontend Architecture: 6 decisions (TypeScript → CSS-in-JS → React 18 → Next.js 14 → Micro-frontends → Testing)');
    console.log('   • Marketing Budget: 4 decisions (Q1 Digital → Q2 Content → Q3 Social → Conference Sponsorships)');
    console.log('   • HR Policy: 7 decisions (4-day week → Team building → Referral → Dev fund → PTO → Performance → Remote stipend)');
